...
fromJSON("https://www.dropbox.com/s/3of3hxzt86oyci8/Gamemaster.json?dl=1", simplifyDataFrame = F) -> Gamemaster
Gamemaster[[1]][c(27)]->Pikachu
Pikachu[[1]]$baseStats->Pikachu_stats
...
# Jigglypuff
fromJSON("https://www.dropbox.com/s/3of3hxzt86oyci8/Gamemaster.json?dl=1", simplifyDataFrame = F) -> Gamemaster
Gamemaster[[1]][c(46)][[1]]$ speciesName<-"Jigglypuff"
Gamemaster[[1]][c(46)][[1]]$ speciesName->Jigglypuff
str(Jigglypuff)
...
提示:
注意Mimikyu的各種資料格式都應該要跟Pikachu、Pikachu他們一樣喔。
```{r ans34}
# Gamemaster
fromJSON("https://www.dropbox.com/s/3of3hxzt86oyci8/Gamemaster.json?dl=1", simplifyDataFrame = F) -> Gamemaster
Gamemaster[[1]][c(27)]->Pikachu

Pikachu[[1]][c(1,2,3,5)]<-list(778,"Mimikyu","Mimikyu",c("ghost","fairy"))
Pikachu->Mimikyu
str(Mimikyu)
